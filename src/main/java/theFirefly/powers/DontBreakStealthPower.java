...
public class DontBreakStealthPower extends AbstractPower implements CloneablePowerInterface {

    public static final String POWER_ID = FireflyMod.makeID("DontBreakStealthPower");
    ...
    public DontBreakStealthPower(final AbstractCreature owner, final int amount) {
        this.name = "Stealthed Weapon";
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
    ...
    public void updateDescription() {
        if (amount == 1) {
            description = "Your next #yAttack does not reduce #yStealth.";
        } else {
            description = "Your next #b" + amount + " #yAttacks don't reduce #yStealth.";
        }
    }

    @Override
    public AbstractPower makeCopy() {
        return new DontBreakStealthPower(owner, amount);
    }
}